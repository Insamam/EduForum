  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">Access your student account</p>
      </div>
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-md font-semibold">Sign In</button>
          </div>
        </form>
